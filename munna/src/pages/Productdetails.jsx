                        ...
                        <div className="pro-group">
                          ...
                          <div className="revieu-box">
                            <ul className="pro-price">
                              ...
                              <li style={{ color: "black", fontSize: "11px" }} onClick={()=>{Data23?.[showoption]?.wishlist_status == true ? Removetowishlist() : Addtowishlist()}}> {Data23?.[showoption]?.wishlist_status == true ? <FaHeart size={19} color="purple" /> : <FaRegHeart size={19} />}</li>
...
<div className="productdetailcontainer customwidth" style={{display:index == 0 && item.brand != "" && item.brand != undefined && item.brand != undefined ? "block" : "none"}}>
                              ...
                              <div className="size-box">
                                <ul>
                                {Data23.map((item,index)=>(
                                      <li style={{height:'auto',width:'fit-content',padding:"3px 4px",background: "purple",display:index == 0 && item.brand != "" && item.brand != undefined ? 'inline-block' : 'none'}}>
                                ...
                                {/* <li style={{ background: "purple" }}><a style={{ color: "white" }} href="javascript:void(0)">l</a></li> */}
                                </ul>
                              </div>
                            </div>
                      ) )}
                        ...
                        {Data23.map((item,index)=>(
                            <div className="productdetailcontainer customwidth" style={{display:index == 0 && item.size != "" && item.size != undefined && item.size != undefined && item.size != 0 ? "block" : "none"}}>
                              ...
                              <div className="size-box">
                                <ul>
                                {Data23.map((item,index)=>(
                                      <li style={{ background: showoption == index ? "purple" : "#fff" }} > 
...
{Data23.map((item,index)=>(
                            <div className="productdetailcontainer customwidth" style={{display:index == 0 && item.weight != "" && item.weight != undefined && item.weight != undefined && item.weight != 0 ? "block" : "none"}}>
                              ...
                              <div className="size-box">
                                <ul>
                                {Data23.map((item,index)=>(
                                      <li style={{ background: showoption == index ? "purple" : "#fff",width:'fit-content',display:'inline-block ',padding:'0px 3px' }} > 
                                        <a href="javascript:void(0)" style={{ color: showoption == index ? "white" : "#333" }} onClick={()=>{setshowoption(index)}}>
                                          {item.weightandtype}
                                        </a>
                                      </li>
                          ...
                          >
                            <div className="pro-group">
                              ...
                              <div className="delivery-detail">
                                ...
                                {/* <p>Delivery by 17 Oct, Tuesday |  <li style={{ color: 'purple', fontWeight: "700", fontSize: "16px" }}><span style={{color: '#CFCFCF'}}>Free</span>  ₹40</li></p> */}
                                <p style={{ color: "red" }}>
