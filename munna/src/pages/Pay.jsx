...
const Pay = () => {
  ...
  const Onlinepay = async () => {
    ...
    var options = {
      key: "rzp_test_AvZKLYbkOHkHPD",
      key_secret: "UWa7Tv513MfbwYSoI7QEEHfu",
        ...
        <div className="custom-container">
          <div className="checkout-page contact-page">
            ...
            <div style={{ display: "flex",justifyContent: "center",alignItems: "center", flexDirection: "column",marginTop: "10px",}}>
                         ...
                         >
                           <source src="/videos/romantic-video6.mp4" // Public folder ka video path
                             type="video/mp4"/>
