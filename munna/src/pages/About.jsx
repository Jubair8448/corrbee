...
<Header />
  ...
  <ul style={{
    ...
    <li style={{ flex: 1 }}>
      <marquee behavior="scroll" direction="left" style={{ color: 'red', fontSize: '20px' }}>
      ARMAN HORERY Corrbee Internation
      </marquee>
    </li>
    <li style={{ flex: 1 }}>
      <marquee behavior="scroll" direction="right" style={{ color: 'green', fontSize: '20px' }}>
      ARMAN HORERY Corrbee Internation
      </marquee>
    </li>
  </ul>
    ...
    <div className="custom-container">
      <div className="row">
        <div className="col-lg-6">
          <div className="banner-section"><img src="./images/BLOG.jpg" className="img-fluid   w-100" alt /></div>
        </div>
        <div className="col-lg-6">
  <h4 className="top-text">
    <b>Welcome to ARMAN HORERY - Redefining Comfort and Style</b>
  </h4>
  <p className="mb-2">
    At <b>ARMAN HORERY</b>, we specialize in designing and manufacturing premium-quality <b>bra and panty</b> products that blend comfort, style, and functionality.
  </p>
  <p className="mb-2">
    Our products are crafted with <b>precision</b> and care, ensuring every piece offers the perfect fit and lasting comfort. We use top-quality fabrics and innovative designs to meet the diverse needs of our customers.
  </p>
  <p className="mb-2">
    From everyday essentials to luxurious lingerie collections, <b>ARMAN HORERY</b> delivers products that cater to every occasion and preference. Our commitment to quality ensures every product is durable, soft on the skin, and aesthetically pleasing.
  </p>
  <p className="mb-2">
    Our team of experts works tirelessly to stay ahead of trends, offering a wide range of sizes, styles, and colors to suit every individual. With <b>ARMAN HORERY</b>, you can trust that every detail is designed with you in mind.
  </p>
  <p className="mb-2">
    Experience the perfect blend of <b>comfort and confidence</b> with ARMAN HORERY – where every product tells a story of elegance and excellence.
  </p>
</div>
        ...
        <OwlCarousel className="owl-theme" style={{width:'100%',height:'100%'}} {...options}>
            ...
            <div className="testimonial-contain">
              <div className="media">
                <div className="testimonial-img">
                  <img src="./images/ON.jpg" className="img-fluid rounded-circle  " alt="testimonial" />
                </div>
                <div className="media-body">
                  <h5>MOHD IRFAN ANSARI</h5>
                  <p><b>Irfan Ansari</b>, the visionary owner of our brand, is committed to delivering exceptional quality products with innovation, precision, and a strong focus on customer satisfaction.</p>
                </div>
              </div>
            </div>
          </div>
          <div>
            <div className="testimonial-contain">
              <div className="media">
                <div className="testimonial-img">
                  <img src="./images/ON1.jpg" className="img-fluid rounded-circle" alt="testimonial" />
                </div>
                <div className="media-body">
                  <h5>MOHD AZAD</h5>
                  <p><b>MOHD AZAD</b>,the visionary owner of our brand, is committed to delivering exceptional quality products with innovation, precision, and a strong focus on customer satisfaction.</p>
                </div>
              </div>
            </div>
          </div>
          <div>
            <div className="testimonial-contain">
              <div className="media">
                <div className="testimonial-img">
                  <img src="./images/ON2.jpg" className="img-fluid rounded-circle" alt="testimonial" />
                </div>
                <div className="media-body">
                  <h5>MUNNA ANSARI</h5>
                  <p><b>MUNNA ANSARI</b>,the visionary owner of our brand, is committed to delivering exceptional quality products with innovation, precision, and a strong focus on customer satisfaction.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="row">
        <div className="col-sm-12">
          ...
          <div className="team-6">
            <div>
              <div>
                <img src="./images/CEO.jpg" className="img-fluid  bg-img" style={{width:'100%'}} alt="team" />
              </div>
              <h4>IRFAN ANSARI</h4>
            ...
            <div>
              <div>
                <img src="./images/CEO1.jpg" className="img-fluid  bg-img" style={{width:'100%'}} alt="team" />
              </div>
              <h4>AZAD ANSARI</h4>
              <h6>CEo &amp; Founder At Company</h6>
            </div>
            <div>
              <div>
                <img src="./images/CEO2.jpg" className="img-fluid  bg-img" style={{width:'100%'}} alt="team" />
              </div>
              <h4>MUNNA ANSARI</h4>
              <h6>CEo &amp; Founder At Company</h6>
            </div>
            <div>
              <div>
                <img src="./images/CEO3.jpg" className="img-fluid  bg-img" style={{width:'100%'}} alt="team" />
              </div>
              <h4>SHAHZAD ANSARI</h4>
              <h6>CEo &amp; Founder At Company</h6>
            </div>
            <div>
              <div>
                <img src="./images/CEO5.jpg" className="img-fluid  bg-img" style={{width:'100%'}} alt="team" />
              </div>
              <h4>JUBAIR ANSARI</h4>
              <h6>CEo &amp; Founder At Company</h6>
            </div>
            ...
            <div>
              <div>
                <img src="./images/CEO6.jpg" className="img-fluid  bg-img" style={{width:'100%'}} alt="team" />
              </div>
              <h4>HASAN ANSARI</h4>
              <h6>CEo &amp; Founder At Company</h6>
            </div>
