    ...
    return (
        <>
            ...
            <section className="section-big-py-space b-g-light  marginfromtop">
                ...
                >
                  <img src="/images/Arrow.png" alt /> Back to Shop
                </h5>
                                ...
                                <br />
                                <h5 style={{ padding: '9px 9px', fontWeight: 400, fontSize: 14, paddingBottom: '20px' }}><img src="/images/Arrow.png" alt /> Back to Shop</h5>
                            </div>
                        </div>
          ...
          <div className="" style={{}}>
            ...
            <h5>Delivery Address</h5>
                <p style={{color: '#2B2A29', fontSize: '13px'}}>corrbee</p>
          ...
          {/* <div className="firstrow px-3 pb-2 d-flex justify-content-between">
            <span style={{fontWeight: 600, fontSize: "17px"}} />
            <span style={{fontWeight: 500, fontSize: 11}}>Available Credit - ₹5001</span>
          </div> */}
        </div>
                        </div>
                    </div>
            ...
            {/*section end*/}<div style={{ display: "flex",justifyContent: "center",alignItems: "center", flexDirection: "column",marginTop: "5px", marginBottom: "10px" }}>
...
>
  <source src="/videos/romantic-video3.mp4" // Public folder ka video path
    type="video/mp4"/>
