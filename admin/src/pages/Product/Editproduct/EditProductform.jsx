                        ...
                        <img
                          src={
                            values.product_image1 === data.data.product_image1
                              ? `${process.env.REACT_APP_BASE_URL}/uploads/images/${data.data.product_image1}`
                    ...
                    <div className="border d-flex justify-content-center">
                      ...
                      >
                        ...
                        <img
                          src={
                            values.product_image1 === data.data.product_image1
                              ? `${process.env.REACT_APP_BASE_URL}/uploads/images/${data.data.product_image2}`
                              : URL.createObjectURL(values.product_image1)
                          }
                          alt="zxcvbnm"
                          width="100%"
                    ...
                    <div className="border d-flex justify-content-center">
                      ...
                      >
                        ...
                        <img
                          src={
                            values.product_image1 === data.data.product_image1
                              ? `${process.env.REACT_APP_BASE_URL}/uploads/images/${data.data.product_image3}`
                              : URL.createObjectURL(values.product_image1)
                          }
                          alt="zxcvbnm"
                          width="100%"
                    ...
                    <div className="border d-flex justify-content-center">
                      ...
                      >
                        ...
                        <img
                          src={
                            values.product_image1 === data.data.product_image1
                              ? `${process.env.REACT_APP_BASE_URL}/uploads/images/${data.data.product_image4}`
                              : URL.createObjectURL(values.product_image1)
                          }
                          alt="zxcvbnm"
                          width="100%"
      ...
      <div className="row">
        ...
        {variantdata.data.map((item, index) => (
          <div className="col-3">
            ...
            <div class="card2">
            <img
  src={`${process.env.REACT_APP_BASE_URL}/uploads/images/${item.product_image1}`}
  alt="zxcvbnm"
  width="100%"
  height="100%"
  style={{ cursor: "pointer" }}
